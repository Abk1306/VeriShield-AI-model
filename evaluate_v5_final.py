...
from create_v5_features import extract_v5_features


MODEL_PATH = Path("verishield_ai/models/tampering_model_v5.joblib")
...
def main():
    ...
    print("\n=== VERISHIELD V5 FINAL FUNSD TEST ===")
    ...
    for category, true_label in CATEGORIES.items():
        ...
        for path in files:
            features, _ = extract_v5_features(str(path))
